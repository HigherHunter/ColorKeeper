...
void Shader::CompileShader(const char* vertexCode, const char* fragmentCode)
{
	...
	uniformShininessLocation = glGetUniformLocation(shaderID, "material.shininess");
...
unsigned Shader::GetEyePositionLocation()
{
...
{
	return uniformShininessLocation;
}

void Shader::SetDirectionalLight(DirectionalLight* dirLight)
{
	dirLight->UseLight(uniformDirectionalLight.uniformAmbientIntensity, uniformDirectionalLight.uniformColor,
